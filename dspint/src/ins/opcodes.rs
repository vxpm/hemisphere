#![expect(dead_code, reason = "a lot is only used during build")]
...
impl OpcodeInfo {
    #[inline(always)]
    pub(super) const fn matches(self, value: u16) -> bool {
...
macro_rules! opcode {
    (
        ...
        impl $e {
            pub(super) const fn find_match(value: u16) -> Self {
                $(
            ...
            #[cfg(test)]
            pub(super) const fn info(self) -> Option<OpcodeInfo> {
                match self {
                    $(
